...
<<<<<<<< HEAD:client/owner/src/components/turf/TurfDetails.jsx
const TurfDetails = () => {
  const isAuthenticated = useSelector((state) => state.auth.isAuthenticated);
========
const FacilityDetails = () => {
  const isLoggedIn = useSelector((state) => state.auth.isLoggedIn);
>>>>>>>> feature/search/thanhlam:client/owner/src/components/turf/FacilityDetails.jsx
  const { id } = useParams();
