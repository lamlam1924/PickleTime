...
const EditOwnerProfileModal = ({ profile, onClose, onSave }) => {
  ...
  const validateForm = () => {
    ...
    // Validate age (>= 18 years for owner)
    if (formData.dateOfBirth) {
      ...
      if (age < 18) {
        newErrors.dateOfBirth = 'Chủ sân phải từ 18 tuổi trở lên';
      }
    }
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-2xl">
        ...
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-2xl">Chỉnh sửa thông tin chủ sân</h3>
          <button 
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                ...
                <span className="label-text-alt text-warning">Phải từ 18 tuổi</span>
              </label>
              <input
                type="date"
                name="dateOfBirth"
